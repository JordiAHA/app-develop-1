        ...
        if(response.status === 200){
            ...
            response.body.data.forEach(user => {
                listUsers = listUsers.concat(`
                    <tr>
                        ...
                        <td>
                        <button type="button" class="btn btn-info" onclick="getUser('$^{user.id}')">Ver</button>
                        </td>
                    </tr>                    
                    `)
            })
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item"><a class="page-link" href="usersPage1" onclick="getUsers('1')">1</a></li>
                    <li class="page-item"><a class="page-link" href="usersPage2" onclick="getUsers('2')">2</a></li>
                    <li class="page-item">
...
function showModalUser(user){
 ...
 function showInfoUser(user){
    const modalUser =
    <!-- Modal -->
<div class="modal fade" id="showModalUser" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">ver user</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        ...<div class="card" >
